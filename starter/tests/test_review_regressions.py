...
from starter import build_graph, write_outputs
...
class AtomicOutputTests(unittest.TestCase):
    ...
    def test_validation_and_json_failures_preserve_previous_generation(self):
        for target in ["storage.validate_bundle", "starter.write_graph_json"]:
            with (
    ...
    def test_validator_pins_a_generation_while_publisher_switches(self):
        ...
        with patch("storage.pd.read_csv", read_and_switch):
            from storage import validate_bundle
